...
// True if `dir` is (or is inside) any repo's worktree root. Used to keep the
// project scanner from offering worktrees as selectable projects.
function isWorktreeDir(dir) {
  return path
    .resolve(dir)
    .split(/[\\/]/)
    .includes(WORKTREE_DIR_NAME);
}
